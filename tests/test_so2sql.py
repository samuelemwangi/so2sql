...
from .mockresponses import tags_data, question_data, answers_data, comments_data
...
class TestSo2Sql(TestCase):
    ...
    def test_fetch_tags_data(self):       
        ...
        with patch.object(So2Sql, 'create_stack_api', return_value=MagicMock()) as mock_create_stack_api:
            ...
            with patch.object(so_2_sql.SITE, 'fetch', return_value=tags_data) as mock_fetch:
                so_2_sql.fetch_tags_data(tags='python')
